...
document.body;
    ...
    * @returns {string} true se a loja estiver aberta, false se estiver fechada.*/
    ...
    function addCustomizableJantinhaToCart(productId) {
        ...
        // Inicializa a opção de acompanhamento (string vazia = "Selecione" ativo)
        }
        cart.push(newItem);
        updateCartDisplay();
        flashCartIcon();
    ...
    function updateCartDisplay() {
        ...
        // ✅ REMOVIDO: O BLOCO PROBLEMÁTICO DOS SELECTS ABAIXO FOI EXCLUÍDO
    ...
    // ✅ MANTIDO (e funciona corretamente): Event delegation global
